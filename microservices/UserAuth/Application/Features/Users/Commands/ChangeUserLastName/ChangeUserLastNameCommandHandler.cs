...
{
    public async Task<ChangeUserLastNameResponse> Handle(ChangeUserLastNameCommand request, CancellationToken cancellationToken)
    {
        ...
        return new ChangeUserLastNameResponse("user lastName changed succsessful");
    }
}
